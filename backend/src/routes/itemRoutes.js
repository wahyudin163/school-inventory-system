...
// Create item
router.post('/', authenticateToken, authorize('admin', 'staff'), upload.single('photo'), validateItem(), validateRequest, itemController.createItem);

// Update item
router.put('/:id', authenticateToken, authorize('admin', 'staff'), upload.single('photo'), itemController.updateItem);
